...
RunConfiguration.setExecutionSettingFile('C:\\Users\\ALEXAN~1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\DeveManipularOcorrencia\\20200317_154153\\execution.properties')
...
not_run: WebUI.click(CustomKeywords.'bizagi.BizagiFile.getTestObject'(GlobalVariable.BINArquivo))

not_run: CustomKeywords.'bizagi.BizagiFile.attachFile'(GlobalVariable.VALArquivoEvidencia)
